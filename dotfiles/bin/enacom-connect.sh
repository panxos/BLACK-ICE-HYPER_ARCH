...
# Configuracion
VPN_NAME="ENACOM"
VPN_CONFIG="${VPN_CONFIG_DIR}/enacom/FARAVENA-ENACOM.ovpn"
AUTH_FILE="${VPN_CONFIG_DIR}/enacom/auth.txt"
CONFIG_IDENTIFIER="FARAVENA-ENACOM.ovpn"
LOG_FILE="/tmp/openvpn-enacom.log"
WAIT_TIME=10

...
# Configuracion
VPN_NAME="TRYHACKME"
VPN_CONFIG="${VPN_CONFIG_DIR}/tryhackme.ovpn"
CONFIG_IDENTIFIER="faravena.ovpn"
LOG_FILE="/tmp/openvpn-thm.log"
WAIT_TIME=8

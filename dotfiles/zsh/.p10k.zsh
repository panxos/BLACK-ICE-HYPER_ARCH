# Generated by Powerlevel10k configuration wizard on 2026-01-04 at 01:33 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs_joined              # git status (unido)
    prompt_char_joined      # prompt symbol >> (unido)
  )

  # The list of segments shown on the right. Fill it with less important segments.
  # Estilo S4vitar: minimalista, sin prompt derecho
  # Puedes descomentar elementos si los necesitas
  ...
  # Sin background para estilo minimalista
  typeset -g POWERLEVEL9K_BACKGROUND=

  # Separator between same-color segments on the left.
  # Estilo Cyberpunk - separadores mínimos
  ...
  # OS identifier color - Cyan para Arch
  ...
  #
  # Configuración de íconos por tipo de directorio - Estilo Cyberpunk
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~(|/*)'       HOME     $'\uF015 '
    '*'            DEFAULT  $'\uF07B '
  )
  ...
  # Background transparente para estilo minimalista
  ...
  function instant_prompt_my_lambda() {
    prompt_my_lambda
  }
